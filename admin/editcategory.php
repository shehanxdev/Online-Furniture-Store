...
<section class="right"><!--new section on the right is open here  -->
	...
	if (isset($_POST['submit'])) { 
		...
		?>
			...
			<h2>Edit Category</h2>  <!-- editing category -->
 
			<form action="" method="POST">

				<input type="hidden" name="id" value="<?php echo $currentCategory['id']; ?>" /> <!--for the id -->
				<label>Name</label>
				<input type="text" name="name" value="<?php echo $currentCategory['name']; ?>" /> <!--for the name -->


				<input type="submit" name="submit" value="Save Category" /> <!-- submit to save category -->
		...
		<?php
			...
			<label>Enter Password</label> <!--the password  -->
