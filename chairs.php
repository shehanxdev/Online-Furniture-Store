...
<html>
	<head>
		...
		<title>Fran's Furniture - Chairs</title>
	</head>
	<body>
	<header>
		<section>
...
<img src="images/randombanner.php"/>
	...
	<section class="left">
        ...
        <li><a href="sofas.php">Sofas</a></li>
            ...
            <li class="current"><a href="chairs.php">Chairs</a></li>
		</ul>
	</section>
	...
	$furnitureQuery = $pdo->prepare('SELECT * FROM furniture  WHERE categoryId = 5 AND hide = 0');
